...
class AKT(nn.Module):
    ...
    def forward_tab(self, feed_dict):
        ...
        out_vector = d_output + q_embed_data  # B, T ,d
        _, _, dim = out_vector.size()
        return out_vector
    ...
    def forward(self, feed_dict):
        ...
        #concat_q = d_output + q_embed_data
        ...
        if self.training:
            ...
            for i in range(0, K, chunk_size):
                ...
                concat_qs = torch.cat([h_4_all_skills, all_skills_emb], dim=-1) #  h_4_all_skills + all_skills_emb
